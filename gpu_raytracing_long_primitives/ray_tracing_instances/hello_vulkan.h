...
static std::string const logPathName = "../media/LogData/strand/(" + std::to_string(minFillDegree) + ")(" + std::to_string(maxFillDegreeDiff) + ")/";
...
public:
    ...
    nvvk::Buffer m_clustersAabbBuffer;  // Buffer of a unit Aabb
