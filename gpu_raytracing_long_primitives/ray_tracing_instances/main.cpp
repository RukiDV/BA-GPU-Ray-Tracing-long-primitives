...
int main(int argc, char** argv)
{
    ...
    summaryFile.open("../media/LogData/instancing/summary.log", std::ios::trunc);
#ifdef EVALUATION_LOGGING
            std::string logPathName = "../media/LogData/instancing/";
    ...
    int status = 0;
      ...
      int status = run("../media/LogData/instancing/(", summaryFile);
#endif
    summaryFile.close();
    return status;
}
